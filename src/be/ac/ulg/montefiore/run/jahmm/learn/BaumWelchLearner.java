...
{	
	...
	{
		System.out.println("Number of states: " + initialHmm.nbStates());
		
		Hmm<O> hmm = initialHmm;
		KullbackLeiblerDistanceCalculator kldc = new KullbackLeiblerDistanceCalculator();
		for (int i = 0; i < nbIterations; i++) {
			hmm = iterate(hmm, sequences);
			System.out.println(i + " " + kldc.distance(hmm, initialHmm));
		}
